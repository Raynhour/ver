...
<?php $idObj = get_category_by_slug('workers'); $id = $idObj->term_id; $n=4;
$recent = new WP_Query("cat=$id&showposts=$n&order=asc");?>
<section class="team">
    <h2 class="team__title align-center"><?php echo $idObj->name; ?></h2>
    <div class="row">
...
<section class="video">
    <div class="row">
        <div class="col-md-7 col-sm-6">
            ...
            <a href="https://www.youtube.com/watch?v=uRL0w1FFrV0" data-lity class="video__link"><img src="<?php echo get_template_directory_uri(); ?>/app/img/play.png"></a>
        </div>
