...
<div class="user-logout">
    <a href="<?php echo get_site_url(); ?>/wp-login.php?action=logout">Выйти</a>
</div>
<?php endif; ?>
...
<script type="text/javascript">
  (function(d, w, s) {
    var widgetHash = 'harpdn76jcr6y8pgpnt7', gcw = d.createElement(s); gcw.type = 'text/javascript'; gcw.async = true;
...
<!-- <script>
    ...
    <link rel="stylesheet" type="text/css" href="https://api.aihelps.com/v1/clients_module_settings/css?codes=887017">
    <link rel="stylesheet" type="text/css" href="https://clients.aihelps.com/css/semantic_ui_module.css">
    <script src="https://clients.aihelps.com/bundle.js" codes="887017" buttonId="beaurypro_open"></script>
...
<script type="text/javascript">
	  (function(d, w, s) {
		var widgetHash = 'emh0ip0foji4vzlzgd9f', gcw = d.createElement(s); gcw.type = 'text/javascript'; gcw.async = true;
		gcw.src = '//widgets.binotel.com/getcall/widgets/'+ widgetHash +'.js';
		var sn = d.getElementsByTagName(s)[0]; sn.parentNode.insertBefore(gcw, sn);
	  })(document, window, 'script');
	</script> </body>
